...
const G6_8_LEVEL_1: MathLevelConfig = {
  ...
  questions: [
    { id: 'g68-l1-q1', type: 'single', prompt: 'What is 3/4 + 1/4?', options: ['1', '4/8', '1/2', '2/4'], answerIndex: 0 },
    ...
    { id: 'g68-l1-q15', type: 'single', prompt: 'What is 2 + 3 × 4?', options: ['20', '14', '24', '12'], answerIndex: 1 },
    ...
    { id: 'g68-l1-boss1', type: 'single', prompt: 'What is 2/3 + 3/4?', options: ['5/7', '17/12', '6/12', '5/12'], answerIndex: 1, isBoss: true },
    { id: 'g68-l1-boss2', type: 'single', prompt: 'What is (−6) × 4?', options: ['24', '−24', '10', '−10'], answerIndex: 1, isBoss: true },
    { id: 'g68-l1-boss3', type: 'single', prompt: 'What is 20% of 45?', options: ['8', '9', '10', '12'], answerIndex: 1, isBoss: true },
  ],
}
